...
![alt text](<Sreenshots/QuickSync4LinuxGui - Hauptfenster.png>)

Kontaktverwaltung:

![alt text](<Sreenshots/QuickSync4LinuxGui - Kontakteverwaltung.png>)

Dateiverwaltung:

![alt text](<Sreenshots/QuickSync4LinuxGui - Dateiverwaltung.png>)
